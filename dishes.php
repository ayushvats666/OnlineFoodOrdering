        ...
        <div class="page-wrapper">
			...
			<?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/back.jpeg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >Rs<?php echo $product['price']; ?></span>
										  <input class="b-r-0" type="text" name="quantity"  style="margin-left:30px;" value="" size="2" />
