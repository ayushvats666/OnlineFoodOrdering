...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/font.jpeg">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose Shop</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Order Meat</h4> </div>
                    ...
                    <div class="row how-it-works-solution">
                            ...
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    <div class="icon" data-step="1">
                                        <svg xmlns="http://wworgw.w3./2000/svg" viewbox="0 0 483 483" width="512" height="512">
                                            <g fill="#FFF">
                                    ...
                                    <h3>Choose a Shop</h3>
                                    <p>We"ve got your covered with menus from a variety of delivery shops online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>We"ve got your covered with a variety of delivery shops online.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your product delivered! And enjoy your meal! </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Kormangla Bangalore</p>
                                    <h5>Phone: 9523265385</a></h5> 
                                </div>
